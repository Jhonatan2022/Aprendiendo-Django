...
class Proyecto(models.Model):
    ...
    user = models.ForeignKey(
        User, on_delete=models.CASCADE, verbose_name="Usuario al que pertenece"
    )
...
class task(models.Model):
    ...
    datecompleted = models.DateTimeField(
        null=True, verbose_name="Fecha de completado", blank=True
    )

    # Creamos un campo para determinar su importancia
    important = models.BooleanField(
        default=False, verbose_name="Importancía de la tarea"
    )
    ...
    project = models.ForeignKey(
        Proyecto, on_delete=models.CASCADE, verbose_name="Proyecto al que pertenece"
    )

    # Usamos el comando BooleanField para definir un campo booleano de las tareas
    done = models.BooleanField(
        default=False, verbose_name="Hecho"
    )  # Ponemos fFlse por defecto
